//
//  ActiveCitizenCDManager.swift
//  ActiveCitizen
//
//  Created by Marco Guilmette on 2016-01-27.
...
class ShoppingListCDManager {
    
    static let sharedInstance = ShoppingListCDManager()
    ...
    func itemFetchedResultsController() -> NSFetchedResultsController {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.infologique.ActiveCitizen" in the application's documents Application Support directory.
